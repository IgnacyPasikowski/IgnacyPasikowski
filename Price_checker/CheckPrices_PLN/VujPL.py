...
from Browser_Actions.Browser_Actions_Vuj import BrowserActionsVuj
...
sheet = workbook.worksheet("VujPL URLS")
sheet2 = workbook.worksheet("VujPL prices")
subsheet_name = "VujPL prices"
dictrionary = "VujDict"
row_index = 1
column_number = 1
...
Browser.quit_driver()
Remove.remove_dup_pln(subsheet_name,dictrionary)
