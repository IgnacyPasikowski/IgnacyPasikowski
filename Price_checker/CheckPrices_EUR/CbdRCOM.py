...
from Browser_Actions.Browser_Actions_CbdR import BrowseractionsCBDR
...
sheet = workbook.worksheet("CbdRCOM URLS")
sheet2 = workbook.worksheet("CBDRCOM Prices")
subsheet_name = "CBDROM Prices"
dictrionary = "CBDR Dict"
row_index = 1
column_number = 1
...
UpdateURLsEUR.cbdr_com_get_urls()
Browser = BrowseractionsCBDR()
