...
from Browser_Actions.Browser_Actions_Vn import BrowserActionsVn
...
sheet = workbook.worksheet("Vn URLS")
sheet2 = workbook.worksheet("Vn prices")
subsheet_name = "Vn prices"
dictrionary = "VnDict"
row_index = 1
column_number = 1
...
UpdateURLsEUR.vn_com_get_urls()
Browser = BrowserActionsVn()
