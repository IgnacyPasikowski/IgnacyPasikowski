...
workbook = client.open("clientEUR")
sheet = workbook.worksheet("VujCOM URLS")
sheet2 = workbook.worksheet("VujCOM prices")
subsheet_name = "VujCOM prices"
dictrionary = "VujDict"
row_index = 1
column_number = 1
...
UpdateURLsEUR.vuj_com_get_urls()
